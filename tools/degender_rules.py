"""Rule data for the Admidio language transform.

Everything that says *what* counts as a gendered construct and what it becomes
lives here; ``degender.py`` holds the machinery that applies it. Splitting the
two keeps the tables readable and makes a wording change a one-file diff.
"""
